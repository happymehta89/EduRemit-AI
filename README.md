...
|---------|------|-------|----------------|------------------|------------------|---------------|
| U001 | Rahul Sharma | rahulsharma91@gmail.com | `GBKIAHACV6WWBFAXXL5BLLMIZQ4CZWQJOEONN777UPABUZZRPUMF32GF` | "The UI for the remittance page is slightly confusing. Could use better labels." | Updated labels on remittance form for clarity | [`2723c1e`](https://github.com/happymehta89/EduRemit-AI/commit/2723c1e) |
| U002 | Priya Patel | priyapatel45@gmail.com | `GBWTAT7JZSXTMIKQMHKLDALRA6ZBEFK6T7FPRDICPQBNWCZA6YT37FPB` | "Transaction history takes too long to load sometimes." | Optimized transaction history API calls and added skeleton loader | [`3068e2e`](https://github.com/happymehta89/EduRemit-AI/commit/3068e2e) |
| U003 | Amit Kumar | amitkumar72@gmail.com | `GDXR33OAC323MB45SYYCTK2IUBOJ2POVKUTLF7Q2K7GQRQNC3EAAJULA` | "I would like to see the exact conversion rate before confirming the transfer." | Added real-time exchange rate preview before confirmation | [`fce3df4`](https://github.com/happymehta89/EduRemit-AI/commit/fce3df4) |
| U004 | Sneha Gupta | snehagupta18@gmail.com | `GBXB5KIP33UEWXS67ZGC6R7DJVGT5URDXQ3C3CKMCRYE5CVAKADBPJ43` | "The font size on the mobile view is a bit too small for me." | Increased base font size for mobile responsiveness | [`ec26276`](https://github.com/happymehta89/EduRemit-AI/commit/ec26276) |
| U005 | Vikram Singh | vikramsingh33@gmail.com | `GDLYECYW23R4K7LLMCNK6ZG4BMA6ODESNTUHNK56E3DOW6723VJ2HX5J` | "Need a way to filter past transactions by date." | Implemented date range filter on transaction history page | [`5bb8117`](https://github.com/happymehta89/EduRemit-AI/commit/5bb8117) |
| U006 | Anjali Desai | anjalidesai88@gmail.com | `GBADPHSX7CUQ4LCGDQNIP4E46T3HI7LV2W2USUNB5NR5ICOEPNK36S6Q` | "The contrast on the submit button isn't great in dark mode." | Fixed button contrast ratio in dark mode theme | [`6a5f3cf`](https://github.com/happymehta89/EduRemit-AI/commit/6a5f3cf) |
| U007 | Rajesh Verma | rajeshverma12@gmail.com | `GB7TNFB6WPTQ76Z3K7XLZLRKAXV4NDAZHR3XRKAMMGY6HMT36JPFFQXJ` | "It would be helpful to have a tooltip explaining gas fees." | Added explanatory tooltips for Stellar network fees | [`1e55887`](https://github.com/happymehta89/EduRemit-AI/commit/1e55887) |
| U008 | Pooja Chatterjee | poojachatterjee56@gmail.com | `GASEBCEBESE4BOY7M2LNUECKXIL7YOWUQODSVYJPKNV2OV3X2Q5WGPEN` | "Sometimes the recipient address validation fails without a clear error." | Improved error messaging for invalid Stellar addresses | [`d429550`](https://github.com/happymehta89/EduRemit-AI/commit/d429550) |
| U009 | Karthik Iyer | karthikiyer29@gmail.com | `GDZRSRB4DOK3372HO2OKYVJKGTL5MYF5VUSO5CD5CJJNQVG35HMBQT6U` | "Can we have a feature to save frequent recipients?" | Added address book feature for frequent recipients | [`f7bde81`](https://github.com/happymehta89/EduRemit-AI/commit/f7bde81) |
| U010 | Meera Reddy | meerareddy67@gmail.com | `GAK6UK2CPLXJIHSXIGQWR3C3NQ53SIJ3NSDUBHLCUHSZ4RDQXP4COFWN` | "The landing page is a bit slow to render initially." | Implemented image lazy loading and deferred non-critical CSS | [`eb192c0`](https://github.com/happymehta89/EduRemit-AI/commit/eb192c0) |
| U011 | Sanjay Mukherjee | sanjaymukherjee94@gmail.com | `GBXRYWWDR7L5RUR2DJFFGPWZ34ENAMAP5XLGWEQOUES2J6VAOGTHOHU3` | "I wish there was an option to export my transfer history." | Added CSV export functionality for transaction history | [`55f658e`](https://github.com/happymehta89/EduRemit-AI/commit/55f658e) |
| U012 | Divya Das | divyadas22@gmail.com | `GAVSIANHYBDPCI4ZF5CWDFLVINXC74PRKEY26JRZ43JC2V2MKIFQCTGU` | "The dashboard feels cluttered with too many cards." | Redesigned dashboard layout to improve visual hierarchy | [`7fc1e2e`](https://github.com/happymehta89/EduRemit-AI/commit/7fc1e2e) |
